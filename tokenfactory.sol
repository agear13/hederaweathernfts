...
contract tokenFactory is Ownable {
    ...
    function newLine(address _artist, address[] memory _agents, uint256[] memory _agentsfees, uint256 _artistfees, uint256 _dorisfees, string memory _name, string memory _symbol, uint256 _maxSupply) public payable onlyDoris {
        new DorisNFT(platform, doris, _artist, _agents, _agentsfees, _artistfees, _dorisfees, _name, _symbol, _maxSupply);
    }
...
contract DorisNFT is ERC721, Ownable {
  using Strings for uint256;
...
constructor(address _platform, address _doris, address _artist, address[] memory _agents, uint256[] memory _agentsfees, uint256 _artistfees, uint256 _dorisfees, string memory _name, string memory _symbol, uint256 _maxSupply) public payable {
...
modifier unpaused {
  ...
  function transferFrom(address from, address to, uint256 tokenId) public payable onlyPlatform unpaused {
